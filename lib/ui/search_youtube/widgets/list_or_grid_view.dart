  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      ElevatedButton(
        ...
        child: Text(viewModel.isListOrGrid ? '리스트' : '그리드',style:TextStyle(fontWeight: FontWeight.w700),),
        style: ButtonStyle(backgroundColor:WidgetStatePropertyAll(Colors.black),foregroundColor: WidgetStatePropertyAll(Colors.white),alignment: Alignment.centerLeft,side: WidgetStatePropertyAll(BorderSide(color: Colors.white,width: 2))) ),
