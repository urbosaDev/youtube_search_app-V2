...
class SearchBodyModel {
  ...
  factory SearchBodyModel.fromJson(Map<String,dynamic> json) {
    final items = (json['items'] as List).map((item) => SearchItemModel.fromJson(item)).toList();
...
class SearchSnippetModel {
  final String publishedAt,channelId,title,description,channelTitle,thumbnailUrl;
